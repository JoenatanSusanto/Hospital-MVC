...
<head>
    ...
    <script>
        function hapus(id) {
            if (confirm('Yakin?')) {
                window.location.href = 'model_koneksi.php?idDokter=' + id;
            } else {
                return true;
            }
        }
...
<nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="./controller_dokter.php">Dokter</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row mb-3">
                <div class="col">
                    <a href="view_tambahdokter.php" class="btn btn-primary btn-sm">Tambah Data</a>
                </div>
            </div>
            <table class="table table-striped table-hover table-sm">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= $row['noTelp']; ?></td>
                        <td>
                            <a href="view_editdokter.php?edit=<?= $row['idDokter']; ?>" class="btn btn-warning btn-sm">Edit</a>
